...
function shouldRenderEvent(event) {
  ...
  // Quanto mais zoom (menor zoomPercent), mais eventos aparecem
  const zoomLevel = 1 - zoomPercent;

  // importance 10 aparece sempre
  // importance 1 só aparece com muito zoom
